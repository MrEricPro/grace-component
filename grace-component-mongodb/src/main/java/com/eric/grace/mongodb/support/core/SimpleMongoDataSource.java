...
import com.eric.grace.mongodb.constant.MongoConst;
import com.eric.grace.mongodb.support.exception.PortNotMatchHostException;
...
/**
 * SimpleMongoDataSource: 简单类型的属性配置，不必须配置List、Map等复杂属性
 *
 * @author: MrEric
 * @since: 2018/9/7 下午4:15
 */
