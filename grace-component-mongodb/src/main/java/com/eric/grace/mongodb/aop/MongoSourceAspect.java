package com.eric.grace.mongodb.aop;
...
/**
 * MongoSourceAspect: mongo数据源切面
 *
 * @author: MrEric
 * @since: 2018/9/7 下午4:00
 */
@Aspect
@Component
@Order(1)
public class MongoSourceAspect {
     ...
     * 定义切入点
     */
    @Pointcut("@annotation(com.eric.grace.mongodb.annotation.DynamicMongoSource)")
