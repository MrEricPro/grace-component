package com.eric.grace.mongodb.factory;

import com.eric.grace.mongodb.dao.MongoAccessor;
import com.eric.grace.mongodb.dao.MongoDbTemplate;
import com.eric.grace.mongodb.exception.DataSourceKeyNotExistException;
import com.eric.grace.mongodb.factory.support.MongoContextHolder;
import com.eric.grace.mongodb.support.core.MongoDataSource;
...
/**
 * MongoFactory: 和spring一起初始化做一些操作,并实例化MongoClient集群
 *
 * @author: MrEric
 * @since: 2018/9/7 下午4:21
 */
@Component
