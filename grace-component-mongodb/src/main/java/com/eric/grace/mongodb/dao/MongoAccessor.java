package com.eric.grace.mongodb.dao;

import com.eric.grace.mongodb.model.MongoStatic;
import com.eric.grace.mongodb.model.PageParam;
import com.eric.grace.mongodb.support.page.Page;
...
/**
 * MongoAccessor: Mongo数据库 dao操作类，基于spring-data-mongodb
 *
 * @author: MrEric
 * @since: 2018/9/7 下午4:07
 */
public abstract class MongoAccessor {
    ...
    public <T> List findListWithDistinct(String key, Class<T> clazz) {
        ...
        org.bson.Document result = mongoTemplate.executeCommand("{distinct:'" + collectionName + "', key:'" + key + "'}");
    ...
    public Document runCommand(String json) {
        ...
        return (Document) mongoTemplate.executeCommand(json);
    }
    ...
    public <T> long update(Query query, Update update, Class<T> clazz) {
        UpdateResult writeResult = mongoTemplate.updateMulti(query, update, clazz);
     ...
     * @return
     */
    public <T> long updateAllByField(String filedName, Object filedValue, TreeMap<String, Object> fieldMap, Class<T> clazz) {
     ...
     * @return
     */
    public <T> long updateAllById(String idVal, TreeMap<String, Object> fieldMap, Class<T> clazz) {
     ...
     * @return
     */
    public <T> long updateAllByField(String condName, Object condVal, String fieldName, Object fieldVlaue, Class<T> clazz) {
     ...
     * @return
     */
    public <T> long updateAllById(String id, String fieldName, Object fieldVlaue, Class<T> clazz) {
     ...
     * @return
     */
    public <T> long removeBeanByQueryAndClass(Query query, Class<T> clazz) {
        DeleteResult writeResult = mongoTemplate.remove(query, clazz);
        long N = writeResult.getDeletedCount();
     ...
     * @return
     */
    public long removeBean(Object removeBean) {
        DeleteResult writeResult = mongoTemplate.remove(removeBean);
        long n = writeResult.getDeletedCount();
     ...
     * @return
     */
    public long removeBeanByQueryAndCollectionName(Query query, String collectionName) {
        DeleteResult writeResult = mongoTemplate.remove(query, collectionName);
        long n = writeResult.getDeletedCount();
        LOG.info("- 删除所有匹配文档集合 ，满足的删除条数:" + n);
        return n;
    }
     ...
     * @return
     */
    public long removeBeanByBeanAndCollectionName(Object removeBean, String collectionName) {
        DeleteResult writeResult = mongoTemplate.remove(removeBean, collectionName);
        long n = writeResult.getDeletedCount();
        LOG.info("- 删除所有匹配文档集合 ，满足的删除条数:" + n);
        return n;
    }
