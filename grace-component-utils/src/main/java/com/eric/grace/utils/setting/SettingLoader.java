...
import com.eric.grace.utils.setting.dialect.BasicSetting;
...
public class SettingLoader {
	private static Logger log = LoggerFactory.getLogger(SettingLoader.class);
